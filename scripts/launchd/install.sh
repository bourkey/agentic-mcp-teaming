...
TEMPLATE="$REPO_ROOT/scripts/launchd/dev.bourkey.agentic-mcp-coordinator.plist.example"
TARGET="$HOME/Library/LaunchAgents/dev.bourkey.agentic-mcp-coordinator.plist"
