...
The coordinator specifies this protocol as a client-side contract so that the companion `consumer-repo` startup skill has one canonical pattern to implement.
