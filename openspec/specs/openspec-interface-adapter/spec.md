# OpenSpec Interface Adapter Specification

## Purpose

Defines how the coordinator consumes Steward's versioned OpenSpec interface and prevents untrusted
artifact text from altering conformance or authorization.
